...
export default function Home() {
  return (
    <div className="min-h-screen bg-stone-900 text-amber-50">
      {/* Hero Section */}
      <div className="relative h-[60vh] flex items-center justify-center bg-[url('/hero-bg.jpg')] bg-cover bg-center">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="space-x-4">
            <Link to="/join" className="bitz-btn text-lg px-8 py-3">
              Join the Empire
            </Link>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bitz-card text-center">
            <div className="text-amber-500 text-4xl mb-4">🏛️</div>
            <h3 className="text-xl font-bold mb-2">Structured Government</h3>
            <p className="text-stone-400">A clear hierarchy ensuring order and prosperity for all citizens.</p>
          </div>
          <div className="bitz-card text-center">
            <div className="text-amber-500 text-4xl mb-4">⚔️</div>
            <h3 className="text-xl font-bold mb-2">Military Might</h3>
